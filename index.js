(function (root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        // TODO: fancier way to make this work with browserify?
        var _;
        try { _ = require('lodash'); } catch (e) {}
        try { _ = require('lodash-compat'); } catch (e) {}
        try { _ = require('lodash-node'); } catch (e) {}

        factory(exports, _);

    } else {
        // Browser globals
        factory((root.commonJsStrict = {}), root._);
    }
    ...
    if (!_) {
        throw new Error('lodash, lodash-compat or lodash-node must be present in the project');
    }
    ...
    exports.deepValues = deepValues;
    exports.compareInt = compareInt;
    exports.compareNumericStrings = compareNumericStrings;
    exports.arrayify = arrayify;
    exports.sortNetworks = sortNetworks;
    exports.compactObject = compactObject;
    exports.compactObjectDeep = compactObjectDeep;
